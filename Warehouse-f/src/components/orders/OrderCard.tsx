            ...
            <div className="flex gap-3 flex-wrap relative z-10">
                ...
                {order.status !== 'DISPATCHED' && order.status !== 'CANCELLED' && (
                    <button
                        ...
                        className="h-12 w-12 flex items-center justify-center rounded-xl bg-background border-2 border-red-500/20 text-red-600 hover:bg-red-500 hover:text-white transition-all shadow-sm"
                ...
                <button
                    ...
                    className="px-6 h-12 flex items-center gap-2 rounded-xl bg-background border-2 border-input-border text-[10px] font-black uppercase tracking-widest text-sharp hover:bg-sharp hover:text-background transition-all"
                >
                    Telemetrics
