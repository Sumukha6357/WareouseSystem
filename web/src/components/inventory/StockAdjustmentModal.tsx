...
export default function StockAdjustmentModal({
    ...
    return (
        <Modal
            isOpen={true}
            onClose={onClose}
            title="Recalibrate Stock"
            maxWidth="md"
        >
            <div className="space-y-10">
                <p className="text-sm font-medium text-muted -mt-6 leading-tight">
                    Modifying <span className="text-primary font-black uppercase">{inventory.product.name}</span> <br />
                    Node: <span className="font-mono text-xs text-sharp">{inventory.blockName}</span>
                </p>
                ...
                <div className="space-y-10">
                    ...
                    <div className="relative group">
                        ...
                        <div className="relative">
                            <input
                                type="number"
                                className="w-full rounded-[2.5rem] border-4 border-input-border bg-background py-7 px-8 focus:ring-8 focus:ring-primary/10 transition-all font-black text-center text-5xl text-sharp outline-none shadow-xl shadow-primary/5"
                                placeholder="0"
                        ...
                        <p className="text-[10px] text-muted mt-5 text-center font-bold uppercase tracking-widest opacity-60 italic">
                            Positive to add inventory, Negative to deduct
                        </p>
                    </div>

                    {adjustmentAmount !== 0 && (
                        <div className="p-6 bg-primary/5 rounded-[2.5rem] border-2 border-primary/20 text-center animate-in fade-in zoom-in-95 duration-500">
                    ...
                    <div className="flex flex-col gap-4 pt-6 border-t border-card-border/30">
                        <Button
                            onClick={onAdjust}
